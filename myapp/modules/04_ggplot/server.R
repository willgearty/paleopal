...
observeEvent(input$mod04_add_option_1, {
  ...
  add_shinypal_plot_step(
    ...
    fun_workflow = mod04_ui_option_1, fun_report = mod04_report_option_1,
    libs = "ggplot2",
...
observeEvent(input$mod04_add_option_2, {
  ...
  add_shinypal_plot_step(
    ...
    fun_workflow = mod04_ui_option_2, fun_report = mod04_report_option_2,
    libs = "ggplot2",
    # the report renders this step into output$map_<ind>, not plot_<ind>
    output_prefix = "map_",
    # surface validation messages before showing the generated code
    code_guard = function() {
      df <- plot_df()
...
observeEvent(input$mod04_add_option_3, {
  ...
  add_shinypal_plot_step(
    ...
    fun_workflow = mod04_ui_option_3, fun_report = mod04_report_option_3,
    # coord_geo() comes from deeptime, so only require it when available
    libs = if (deeptime_available) c("ggplot2", "deeptime") else "ggplot2",
    # surface validation messages before showing the generated code
    code_guard = function() {
      df <- plot_df()
      validate(need(is.numeric(df[[input[[paste0("column_", ind, "_1")]]]]),
...
observeEvent(input$mod04_add_option_4, {
  ...
  add_shinypal_plot_step(
    ...
    fun_workflow = mod04_ui_option_4, fun_report = mod04_report_option_4,
    libs = "ggplot2",
    # surface validation messages before showing the generated code
    code_guard = function() {
      df <- plot_df()
